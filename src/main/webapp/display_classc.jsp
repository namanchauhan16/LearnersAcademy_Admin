...
<body>
	...
	if (Objects.nonNull(classc)) {
	%>
	<h3>Record of Class C</h3>
	<br>
	...
	<table class="table table-striped">
		...
		<tbody>
			<%
			List<HashMap<Object, Object>> classcList = new ObjectMapper().readValue(classc, List.class);

			for (HashMap<Object, Object> eachMap : classcList) {
