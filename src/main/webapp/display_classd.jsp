...
<body>
	<%
	String classd = request.getParameter("classd");
	if (Objects.nonNull(classd)) {
	%>
	<h3>Record of Class D</h3>
	<br>
	...
	<table class="table table-striped">
		...
		<tbody>
			<%
			List<HashMap<Object, Object>> classdList = new ObjectMapper().readValue(classd, List.class);

			for (HashMap<Object, Object> eachMap : classdList) {
